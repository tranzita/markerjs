...
import { SixMarkerState } from './SixMarkerState';

export class SixMarker extends RectangularMarkerBase {
    public static createMarker = (): SixMarker => {

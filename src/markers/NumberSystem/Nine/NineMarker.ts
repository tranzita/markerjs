...
import { NineMarkerState } from './NineMarkerState';

export class NineMarker extends RectangularMarkerBase {
    public static createMarker = (): NineMarker => {
    ...
    private readonly DEFAULT_TEXT = "9";
    private text: string = this.DEFAULT_TEXT;
    private textElement: SVGTextElement;
    private inDoubleTap = false;
    private editor: HTMLDivElement;
    private editorTextArea: HTMLTextAreaElement;
    public getState(): NineMarkerState {
        const state: NineMarkerState = Object.assign(
            { text: this.text }, super.getState()); 
        return state;
    }
    public restoreState(state: NineMarkerState) {

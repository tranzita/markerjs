...
import { ThreeMarkerState } from './ThreeMarkerState';

export class ThreeMarker extends RectangularMarkerBase {
    public static createMarker = (): ThreeMarker => {
    ...
    private readonly DEFAULT_TEXT = "3";
    private text: string = this.DEFAULT_TEXT;
    private textElement: SVGTextElement;
    private inDoubleTap = false;
    private editor: HTMLDivElement;
    private editorTextArea: HTMLTextAreaElement;
    public getState(): ThreeMarkerState {
        const state: ThreeMarkerState = Object.assign(
            { text: this.text }, super.getState()); 
        return state;
    }
    public restoreState(state: ThreeMarkerState) {

...
import { SevenMarkerState } from './SevenMarkerState';

export class SevenMarker extends RectangularMarkerBase {
    public static createMarker = (): SevenMarker => {
    ...
    private readonly DEFAULT_TEXT = "7";
    private text: string = this.DEFAULT_TEXT;
    private textElement: SVGTextElement;
    private inDoubleTap = false;
    private editor: HTMLDivElement;
    private editorTextArea: HTMLTextAreaElement;
    public getState(): SevenMarkerState {
        const state: SevenMarkerState = Object.assign(
            { text: this.text }, super.getState()); 
        return state;
    }
    public restoreState(state: SevenMarkerState) {

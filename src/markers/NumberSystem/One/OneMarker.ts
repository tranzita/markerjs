...
import { OneMarkerState } from './OneMarkerState';

export class OneMarker extends RectangularMarkerBase {
    public static createMarker = (): OneMarker => {

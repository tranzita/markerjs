...
import { TwoMarkerState } from './TwoMarkerState';

export class TwoMarker extends RectangularMarkerBase {
    public static createMarker = (): TwoMarker => {

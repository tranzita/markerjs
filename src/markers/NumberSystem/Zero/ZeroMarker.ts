...
import { ZeroMarkerState } from './ZeroMarkerState';

export class ZeroMarker extends RectangularMarkerBase {
    public static createMarker = (): ZeroMarker => {
    ...
    constructor() {
        super();
        this.markerTypeName = 'ZeroMarker';
    }
    protected readonly MIN_SIZE = 50;

    private readonly DEFAULT_TEXT = "0";
    private text: string = this.DEFAULT_TEXT;
    private textElement: SVGTextElement;
    private inDoubleTap = false;
    private editor: HTMLDivElement;
    private editorTextArea: HTMLTextAreaElement;
    public getState(): ZeroMarkerState {
        const state: ZeroMarkerState = Object.assign(
            { text: this.text }, super.getState()); 
        return state;
    }
    public restoreState(state: ZeroMarkerState) {

...
import { FiveMarkerState } from './FiveMarkerState';

export class FiveMarker extends RectangularMarkerBase {
    public static createMarker = (): FiveMarker => {
    ...
    private readonly DEFAULT_TEXT = "5";
    private text: string = this.DEFAULT_TEXT;
    private textElement: SVGTextElement;
    private inDoubleTap = false;
    private editor: HTMLDivElement;
    private editorTextArea: HTMLTextAreaElement;
    public getState(): FiveMarkerState {
        const state: FiveMarkerState = Object.assign(
            { text: this.text }, super.getState()); 
        return state;
    }
    public restoreState(state: FiveMarkerState) {
